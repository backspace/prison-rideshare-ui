...
<div class="switch-container layout-row layout-align-start-center">
  <PaperSwitch @class="inactive" @value={{@controller.showInactive}} @onChange={{fn (mut @controller.showInactive)}}>
    Inactive
  </PaperSwitch>
</div>
  ...
  <PaperDialog @clickOutsideToClose={{true}} @fullscreen={{true}} @onClose={{@controller.cancelPerson}}>
    <PaperDialogContent>
      ...
      <PaperForm @onSubmit={{@controller.savePerson}} as |form|>
        <PaperRadioGroup @groupValue={{readonly @controller.editingPerson.medium}} @onChange={{fn (mut @controller.editingPerson.medium)}} as |group|>
          <div class="layout layout-sm-column">
            <form.input @class="name" @label="Name" @autofocus={{true}} @value={{@controller.editingPerson.name}} @onChange={{fn (mut @controller.editingPerson.name)}} @errors={{@controller.editingPerson.validationErrors.name}} @isTouched={{readonly @controller.editingPerson.validationErrors.name.length}} />
          </div>
          <div class="layout layout-sm-column text-radio email">
            <form.input @type="email" @label="Email" @value={{@controller.editingPerson.email}} @onChange={{fn (mut @controller.editingPerson.email)}} @errors={{@controller.editingPerson.validationErrors.email}} @isTouched={{readonly @controller.editingPerson.validationErrors.email.length}} />
            <group.radio @value="email">
              {{paperIcon "favorite"}}
            </group.radio>
          </div>
          <div class="layout layout-sm-column text-radio mobile">
            <form.input @type="mobile" @label="Mobile" @value={{@controller.editingPerson.mobile}} @onChange={{fn (mut @controller.editingPerson.mobile)}} @errors={{@controller.editingPerson.validationErrors.mobile}} @isTouched={{readonly @controller.editingPerson.validationErrors.mobile.length}} />
            <group.radio @value="mobile">
              {{paperIcon "favorite"}}
            </group.radio>
          </div>
          <div class="layout layout-sm-column text-radio landline">
            <form.input @type="mobile" @label="Landline" @value={{@controller.editingPerson.landline}} @onChange={{fn (mut @controller.editingPerson.landline)}} @errors={{@controller.editingPerson.validationErrors.landline}} @isTouched={{readonly @controller.editingPerson.validationErrors.landline.length}} />
            <group.radio @value="landline">
              {{paperIcon "favorite"}}
            </group.radio>
          </div>
          <div class="layout layout-sm-column">
            <form.input @textarea={{true}} @class="address" @label="Mailing address" @value={{@controller.editingPerson.address}} @onChange={{fn (mut @controller.editingPerson.address)}} @errors={{@controller.editingPerson.validationErrors.address}} @isTouched={{readonly @controller.editingPerson.validationErrors.address.length}} />
          </div>
          <div class="layout layout-sm-column">
            <form.input @textarea={{true}} @class="notes" @label="Notes" @value={{@controller.editingPerson.notes}} @onChange={{fn (mut @controller.editingPerson.notes)}} @errors={{@controller.editingPerson.validationErrors.notes}} @isTouched={{readonly @controller.editingPerson.validationErrors.notes.length}} />
          </div>
        </PaperRadioGroup>
      </PaperForm>
    </PaperDialogContent>
